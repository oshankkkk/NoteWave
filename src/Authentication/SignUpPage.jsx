...
export default function SignUpPage() {
  ...
  const handleGoogleSignupWithValidation = () => {
    ...
    handleGoogleSignup(username); // optionally pass username to the function
  };
    ...
    <div className="min-h-screen flex items-center justify-center p-3 bg-purple-600">
      <div className="bg-white p-5 rounded-2xl">
        <div>
          ...
          <button
            onClick={handleGoogleSignupWithValidation}
            className="w-full mt-2 flex items-center justify-center gap-3 px-4 py-3 border border-gray-300 rounded-lg bg-white text-gray-700 font-medium"
          >
